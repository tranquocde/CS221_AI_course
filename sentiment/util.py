...
def readExamples(path: str) -> List[Tuple[T, int]]:
    '''
...
def evaluatePredictor(examples: List[Tuple[FeatureVector, int]], predictor: Callable) -> float:
    '''
...
def outputErrorAnalysis(examples: List[Tuple[FeatureVector, int]], featureExtractor: Callable[[T], FeatureVector], weights: WeightVector, path: str):
...
def interactivePrompt(featureExtractor: Callable[[T], FeatureVector], weights: WeightVector):
    while True:
        print('> ', end=' ')
